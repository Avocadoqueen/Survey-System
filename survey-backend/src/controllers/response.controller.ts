...
export class ResponseController {
  ...
  public getResponseByUserId = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
  ...
  public getResponseBySurveyId = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
  ...
  public getResponseByQuestionId = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
    try {
      ...
      const response = await this.responseService.findResponseByQuestionId(questionId);
      res.status(200).json({ data: response, message: 'Response fetched' });
    } catch (error) {
      next(error);
    }
  ...
  public updateResponseById = async (
    ...
    try {
      ...
      const response = await this.responseService.updateResponseById(responseId, req.body);
  ...
  public deleteResponseById = async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
    try {
      const responseId = Number(req.params.id);
      await this.responseService.deleteResponse(responseId);
